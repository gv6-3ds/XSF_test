% Autogenerated file: Thu Feb  2 10:52:00 2023
...
wr = coder.internal.writeDataInterfacesToCodeDescriptor("LaneKeeping",pwd) ;
...
skippedParameters = [];
    ...
    Type_26_R0_V0_C0.BaseType   = Type_3_R0_V0_C0;
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        ...
        func_Initialize_Prototype.HeaderFile = 'LaneKeeping.h';
    func_Initialize_Prototype.SourceFile = 'LaneKeeping.c';
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'LaneKeeping_initialize';
    ...
    func_OutputUpdate_Prototype.Return     = tmpRet;
        ...
        func_OutputUpdate_Prototype.HeaderFile = 'LaneKeeping.h';
    func_OutputUpdate_Prototype.SourceFile = 'LaneKeeping.c';
    ...
    func_OutputUpdate_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate_Prototype.Name = 'LaneKeeping_step';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        ...
        func_Terminate_Prototype.HeaderFile = 'LaneKeeping.h';
    func_Terminate_Prototype.SourceFile = 'LaneKeeping.c';
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['LaneKeeping_terminate'];
        codeInfo.TerminateFunctions =  [codeInfo.TerminateFunctions, func_Terminate_Interface'];
            ...
            type_RTModel.Identifier = 'RT_MODEL_LaneKeeping_T';
        ...
        Var_RTModel = RTW.Variable(Ptrtype_RTModel_1_0.BaseType, 'LaneKeeping_M_');
        Var_RTModel.Owner           = 'LaneKeeping';
        Var_RTModel.DeclarationFile = 'LaneKeeping.h';
            Var_RTModel.DefinitionFile  = 'LaneKeeping.c';
        

        % Pointer Variable: PtrVar_RTModel
        PtrVar_RTModel = RTW.PointerVariable(Ptrtype_RTModel_1_0, 'LaneKeeping_M', Var_RTModel);
